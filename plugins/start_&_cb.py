...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/Yugen_Bots'),
      InlineKeyboardButton('💬 Support', url='https://t.me/Yugen_Bots_Support')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Owner 🧑‍💻", url='https://t.me/voatcb')
    ]])
    if Config.START_PIC:
